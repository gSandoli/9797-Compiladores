...
#line 661 "parser.tab.cc"
  ...
  case 11:
#line 94 "parser.yy"
                { std::cout << "Simbolo: " << *(yystack_[0].value.stringVal) << std::endl; }
...
#undef YYCASE_
  ...
  "\"symbolVal\"", "\"iniBloco\"", "\"fimBloco\"", "$accept", "program",
  "constant", "variable", "keyword", "symbol", YY_NULLPTR
  };
