...
public:
  ...
  FunctionTable() {
    ...
    add("imprimei", "inteiro",
        "void"); // Imprime uma contante inteiro na saída padrão.
    add("imprimer", "real",
        "void");              // Imprime uma constante real na saída padrão.
    ...
    add("ordem", "cadeia",
        "inteiro"); // Retorna o valor ASCII do primeiro caracter da cadeia ou
                    // -1 se a cadeia é vazia.
    add("chr", "inteiro", "cadeia"); // Retorna o caracter para o valor ASCII i.
                                     // Erro de execução se o valor é inválido.
    add("tamanho", "cadeia",
        "inteiro"); // Retorna a quantidade de caracteres da cadeia.
    add("subcadeia", "cadeia,inteiro,inteiro",
        "cadeia"); // Retorna a subcadeia de c iniciando no caracter i, composta
                   // por n caracteres. O primeiro caracter inicia na posição 0.
    add("concatene", "cadeia,cadeia",
        "cadeia"); // Retorna uma nova cadeia formada por c1 seguida por c2.
    add("inverter", "inteiro",
        "inteiro"); // Retorna 1 se a i for zero, ou 0 caso contrário.
    add("termine", "inteiro",
        "void"); // Termina a execução do programa com o código i.
