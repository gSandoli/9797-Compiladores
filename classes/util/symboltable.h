...
template <typename T> T *&SymbolTable<T>::operator[](const std::string &name) {
  return lookup(name);
}

template <typename T> T *&SymbolTable<T>::lookup(const std::string &name) {
...
template <typename T> T *&SymbolTable<T>::lookupOne(const std::string &name) {
...
template <typename T> void SymbolTable<T>::popOne(const std::string &name) {
